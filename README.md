...
[postgresql] 
host=localhost 
user=postgres/или другой 
ваше имя, по которому зарегистрированы в pgAdmin 
password=ваш пароль 
port=5432
Пример указан в файле database.ini.example
...
Создан класс DBManager, который будет подключаться к БД PostgreSQL и имеет следующие методы:
